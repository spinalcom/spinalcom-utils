...
export declare function cloneAndPackAll(packageToInstall: string[], cacheDirPath: string, mainPackageJsonPath: string, resolvedConfit: IConflit, isDryRun: boolean, addPostInstall: boolean): Promise<{
